...
"""
SQLALCHEMY_DATABASE_URL = "mysql+asyncmy://kinit:FRJpmBnAJPnDp2zY@107.172.190.247:3306/kinit"
...
REDIS_DB_URL = "redis://:redis_PPksDb@107.172.190.247:6379/1"
...
MONGO_DB_NAME = "admin"
MONGO_DB_URL = f"mongodb://mongo_hxFf8M:mongo_CJat3C@107.172.190.247:27017/?authSource={MONGO_DB_NAME}"
